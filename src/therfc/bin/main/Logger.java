...
public class Logger {
    ...
    static {
        ...
        objects.put("therfc.bin.data.Worker", "Worker");
        objects.put("therfc.bin.data.Box", "Box");
        objects.put("therfc.bin.data.SteppableField", "SteppableField");
        objects.put("therfc.bin.data.TargetField", "TargetField");
        objects.put("therfc.bin.data.Switch", "Switch");
        objects.put("therfc.bin.data.Hole", "Hole");
        objects.put("therfc.bin.data.Wall", "Wall");
        objects.put("therfc.bin.data.Warehouse", "Warehouse");
        objects.put("therfc.bin.data.Game", "Game");
        objects.put("therfc.bin.data.Honey", "Honey");
        objects.put("therfc.bin.data.Oil", "Oil");
        objects.put("null", " ");
    }
